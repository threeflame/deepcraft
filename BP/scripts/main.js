...
system.runInterval(() => {
    ...
    world.getAllPlayers().forEach(player => {
        ...
        player.onScreenDisplay.setActionBar(`§b[Slot ${profile}] §eLv.§l${level} §r§f[XP: §a${xp}§f / §c${reqXp}§f]`);
